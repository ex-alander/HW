...
int main()
{
    ...
    /*long->repeats_yes*/
    const string pattern = "qwertyuiopqwer"; // for qwertyuiop text // scores 73 times on a 11400 text 
    
    /*long->repeats_no*/
    //const string pattern = "qwerty"; // for qwertyuiop text
    
    /*short->repeats_yes*/
    //const string pattern = "ll"; // for War&Peace text, 45 times
    
    /*short->repeats_no*/
    //const string pattern = "q"; //for qwertyuiop text, 100 times

    //const string pattern = " "; // scores 2014 times on a 11400 text 
    //const string pattern = "ll"; // scores 45 times on a 11400 text 
    //const string pattern = "a"; // scores 726 times on a 11400 text 
